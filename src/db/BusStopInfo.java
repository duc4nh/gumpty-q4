...
public class BusStopInfo 
{
  ...
  public static int findBusStop(String areaCode, String name)
  {
    ...
    return database.busDatabase.find_id("bus_stop_id", source, "area.name", areaCode, "bus_stop.name", name);
  }
  ...
  /**
   * Returns the id of the area associated with the given bus stop
   */
  public static int getAreaByStop(int busStopId) {
	  if (busStopId == 0) throw new InvalidQueryException("Nonexistent bus stop");
	  return database.busDatabase.get_int("bus_stop", busStopId, "area");
  }
