...
public class database
{
  ...
  /**
   * Instantiates the busDatabase; username and password are read from 'login.passwd' file, in that order
   */
    public static void openBusDatabase() {
    try {
    	Scanner fin = new Scanner(new FileInputStream("login.passwd"));
    	String username = fin.next();
    	String password = fin.next();
    	
        busDatabase = new database("2013_comp23420_q4",   // db name
                                   username,              // username
                                   password,              // password
  ...
  public int record_count(String target, String source, String criteria)
  {
    ...
    {
      throw new InvalidQueryException("Database count failed" + ex);
    }
  }
  ...
  public void select(String target, String source, String criteria, String order)
  {
    ...
    {
      throw new InvalidQueryException("Database access failed " + ex);
    }
  }
  ...
  public Boolean set_field(String field_name, Object value)
  {
    ...
    {
      throw new InvalidQueryException("Database update failed" + ex);
    }
  }
  ...
  public Boolean close()
  {
    ...
    {
      throw new InvalidQueryException("Closing database failed" + ex);
    }
  }
  ...
  private Boolean connect()
  {
    ...
    {
      throw new InvalidQueryException("Unable to connect to database" + ex);
    }
  }
  ...
  private Boolean disconnect()
  {
    ...
    {
      throw new InvalidQueryException("Unable to disconnect to database" + ex);
    }
  }
  ...
  private Boolean find_driver()
  {
    ...
    {
      throw new InvalidQueryException("Unable to find database driver" + ex);
    }
  }
